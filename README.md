...
5. Copiaza `database/db_config.example.php` in `database/db_config.php`.
6. Completeaza in `database/db_config.php` datele tale locale de conectare la MySQL.
7. Acceseaza `index.html` in browser.

## Configurarea bazei de date

Fisierul versionat in GitHub este `database/db_config.example.php`.

Fisierul local folosit de aplicatie este `database/db_config.php`, iar acesta este ignorat de Git. Structura asteptata este:
